...
public class UDP_MusicServer extends Thread{
    private Socket ss;

    private UDP_MusicServer(Socket ss) {
        this.ss = ss;
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        while(true){
            ...
            new UDP_MusicServer(socket).start();
        }
    }
    ...
    public void run() {
        try {
            ...
            if (choice.equals("Download")){
                List<String> list=movieServer.getAllFiles("MusicServer");
